...
public class TC004_DELETET_DeleteStudent extends TestBase{
	@BeforeClass
	void deleteStudent() {
		logger.info("--------TC004_DeleteT_Student Started-----------");
		...
		int studentID=jsonpath.get("[0].id");
		 response=httpRequest.request(Method.DELETE,"/"+studentID);
	}
	...
	@AfterClass
	void tearDown() {
		logger.info("--------TC004_DELETE_SingleStudents Finished-----------");
	}
}
